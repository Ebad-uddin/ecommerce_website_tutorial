		...
		<div class="colorlib-product">
			<div class="container">
				...
				<div class="row row-pb-md">
					<?php 
					$select_prod = mysqli_query($connection, "SELECT * from product as p inner join category as c on p.p_cat = c.cat_id WHERE c.cat_name = 'best sellers'");
					if(mysqli_num_rows($select_prod) > 0){
						while ($data = mysqli_fetch_assoc($select_prod)){
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="#" class="prod-img">
								<img src="<?php echo '../adminpanel/uploads/' . $data['pimage']?>" class="img-fluid" alt="Free html5 bootstrap 4 template">
							</a>
							<div class="desc">
								<h2><a href="#"><?php echo $data['pname'] ?></a></h2>
								<span class="price"><?php echo $data['pname'] ?></span>
							</div>
						</div>
					</div>
					<?php 
